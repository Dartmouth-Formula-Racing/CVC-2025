...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PB1     ------> ADC1_IN9
    */
    GPIO_InitStruct.Pin = DCDC_Voltage_Pin|Brake_Pressure_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = APPS_1_Pin|APPS_2_Pin|Current_Sensor_Pin|Steering_Angle_Pin
                          |Inverter1_CS_Pin|Inverter2_CS_Pin|Pump1_CS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(GPIOC, DCDC_Voltage_Pin|Brake_Pressure_Pin);

    HAL_GPIO_DeInit(GPIOA, APPS_1_Pin|APPS_2_Pin|Current_Sensor_Pin|Steering_Angle_Pin
                          |Inverter1_CS_Pin|Inverter2_CS_Pin|Pump1_CS_Pin);
